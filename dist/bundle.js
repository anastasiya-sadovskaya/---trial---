...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__elementFactory__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__youTubeApiClient__ = __webpack_require__(50);
...
/* harmony default export */ __webpack_exports__["a"] = ((function AppManager() {
    return {
        ...
        searchButton: __WEBPACK_IMPORTED_MODULE_0__elementFactory__["a" /* default */].create('button', { class: 'search', id: 'search' }, { innerHTML: 'Search', onclick: __WEBPACK_IMPORTED_MODULE_2__app__["onSearchSuccessCallback"] }),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__appManager__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__appSettings__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__youTubeApiClient__ = __webpack_require__(50);
...
/* harmony export (immutable) */ __webpack_exports__["onSearchSuccessCallback"] = onSearchSuccessCallback;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_polyfill__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__appManager__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appSettings__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__youTubeApiClient__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__searchResult__ = __webpack_require__(120);
...
document.body.appendChild(__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].disableScreen);
__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].disableScreen.style.display = 'none';
document.body.appendChild(__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].spiner);
__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].spiner.style.display = 'none';
__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].videoNodes = [];
__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].pageControllers = [];

document.body.onresize = function () {
    __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].screenWidth = document.body.offsetWidth;
    if (__WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].screenWidth < 400) {
        __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidth = __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].screenWidth;
        document.body.className = 'phone';
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].searchInput.className = 'phone';
        search.className += ' phone';
    } else {
        __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidth = __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidthExceptPhones;
        document.body.className = '';
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].searchInput.className = '';
        search.className = 'search';
    }
    __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].videoNodes.map(function (el) { el.DOMElement.style.width = `${__WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidth}px` });
    if (__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList) {
        var videosOnPage;
        if (__WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].screenWidth < 400) {
            videosOnPage = 1;
        } else {
            videosOnPage = __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.videosOnPage();
        }
        let margin = ((__WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].screenWidth - (__WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidth * videosOnPage)) / (videosOnPage * 2));
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.setMargin(margin);

        let width = (__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.videoNodes.length * __WEBPACK_IMPORTED_MODULE_2__appSettings__["a" /* default */].videoNodeWidth) + (__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.videoNodes.length * margin * 2);
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.setWidth(width);

        var page = Math.ceil(((__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.page - 1) * __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.prevVideosOnPageNumber + 1) / videosOnPage);
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.setPage(page);
    }
};


document.body.appendChild(__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].searchInput);
document.body.appendChild(__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].searchButton);

document.onkeypress = function (event) {
    if (event.keyCode == 13) {
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].searchButton.click();
    }
};

function renderPreviews() {
    var list = new __WEBPACK_IMPORTED_MODULE_4__searchResult__["a" /* default */];
    list.create();
}
...
function onSearchSuccessCallback() {
    console.log('hello');
    if (__WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList) {
        __WEBPACK_IMPORTED_MODULE_1__appManager__["a" /* default */].resultsList.remove();
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__appManager__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__appSettings_js__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__elementFactory__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__youTubeApiClient__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__videoNode__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__button__ = __webpack_require__(302);
...
class SearchResult {
    ...
    create() {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].responsItemsCount != 0) {
            if (__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].screenWidth < 400) {
                self.createNodes(__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].screenWidth);
            } else {
            ...
            let width = (self.videoNodes.length * __WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].videoNodeWidth) + (self.videoNodes.length * margin * 2);
            this.setWidth(width);

            document.body.appendChild(self.DOMElement);
            self.controllers = __WEBPACK_IMPORTED_MODULE_2__elementFactory__["a" /* default */].create('div', { class: 'controllers' });
            ...
            var firstLoadPagesCount = Math.ceil(__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].responsItemsCount / self.videosOnPage());
            ...
            self.setWidth(__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].screenWidth);
            document.body.appendChild(self.DOMElement);
            self.page = 1;
                    ...
                    if (delta > 0) {
                        if (delta > self.swipeLength) {
                            if (self.page != self.lastPage) {
                                ...
                                list.style.transform = `translate(${self.currentTranslate}px)`;
                                for (let i = 0; i < 5; i++){
                                    if(__WEBPACK_IMPORTED_MODULE_0__appManager__["a" /* default */].pageControllers[i].DOMElement.innerHTML == self.page){
                                        for(let j = 4; j > i; j--){
    ...
    setPage(pageNum) {
        ...
        self.DOMElement.style.transform = `translateX(-${(pageNum - 1) * __WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].screenWidth}px)`;
        self.currentTranslate = -((pageNum - 1) * __WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].screenWidth);
        self.calcLoadPage();
        self.onPageSet();
    ...
    calcLoadPage() {
        self.pageForLoad;
        var tempPageForLoad = __WEBPACK_IMPORTED_MODULE_0__appManager__["a" /* default */].videoNodes.length / self.videosOnPage();
    ...
    calcLastPage() {
        let lastVideos = __WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].responsItemsCount / self.videosOnPage();
        if (__WEBPACK_IMPORTED_MODULE_1__appSettings_js__["a" /* default */].responsItemsCount < 15) {
            if (Math.ceil(lastVideos) === lastVideos) {
                self.lastPage = __WEBPACK_IMPORTED_MODULE_0__appManager__["a" /* default */].videoNodes.length / self.videosOnPage();
            } else {
                self.lastPage = Math.ceil(__WEBPACK_IMPORTED_MODULE_0__appManager__["a" /* default */].videoNodes.length / self.videosOnPage());
            }
        } else {
            self.lastPage = Math.ceil(__WEBPACK_IMPORTED_MODULE_0__appManager__["a" /* default */].videoNodes.length / self.videosOnPage());
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__appManager__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__elementFactory__ = __webpack_require__(62);
